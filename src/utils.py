...
def parse_args():
    ...
    parser.add_argument("--obs_data_name", default="observation_syn", type=str)
    parser.add_argument("--rec_data_name", default="recommendation_small_v1", type=str)
    parser.add_argument("--dec_data_name", default="decision_small_v1", type=str)
    parser.add_argument("--do_eval", action="store_true")
    parser.add_argument("--load_model", default=None, type=str)
    parser.add_argument("--load_pretrain_model", default='BSARec_books', type=str)
    ...
    parser.add_argument("--TE_model", action="store_true")
    parser.add_argument("--load_model_TE", default=None, type=str)
    parser.add_argument("--CSRec_TE_model", action="store_true")
